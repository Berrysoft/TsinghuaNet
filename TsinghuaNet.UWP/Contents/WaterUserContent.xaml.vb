...
Public NotInheritable Class WaterUserContent
    ...
    Public Shared ReadOnly UserProperty As DependencyProperty = DependencyProperty.Register(NameOf(User), GetType(FluxUser), GetType(WaterUserContent), New PropertyMetadata(Nothing, AddressOf UserPropertyChanged))
