...
Public NotInheritable Class WaterUserContent
    ...
    Public Shared ReadOnly UserProperty As DependencyProperty = DependencyProperty.Register(NameOf(User), GetType(FluxUserBox), GetType(WaterUserContent), New PropertyMetadata(Nothing, AddressOf UserPropertyChanged))
    ...
    Private Shared Sub UserPropertyChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        Dim content As WaterUserContent = d
    ...
    Public Shared ReadOnly OnlineTimeProperty As DependencyProperty = DependencyProperty.Register(NameOf(OnlineTime), GetType(TimeSpan), GetType(WaterUserContent), New PropertyMetadata(TimeSpan.Zero))
    ...
    Public Shared ReadOnly FreeOffsetProperty As DependencyProperty = DependencyProperty.Register(NameOf(FreeOffset), GetType(Double), GetType(WaterUserContent), New PropertyMetadata(0.0))
    ...
    Public Shared ReadOnly FluxOffsetProperty As DependencyProperty = DependencyProperty.Register(NameOf(FluxOffset), GetType(Double), GetType(WaterUserContent), New PropertyMetadata(0.0))
